...
#include "../../Interfaces/CEventsInterface.h"
//#include "../../../../Shared/Scripting/CScriptArguments.h"
...
namespace Modules
{
	...
	public:
		...
		virtual bool TriggerEvent(EntityId playerid, const char * szEventName, const char * szFormat, ScriptArgumentsInterface* args = NULL, ...) = 0;
