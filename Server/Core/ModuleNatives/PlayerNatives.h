...
#include <Scripting/CScriptArguments.h>
...
namespace Modules
{
	...
	public:
		...
		bool TriggerEvent(EntityId playerid, const char * szEventName, const char * szFormat, ScriptArgumentsInterface* pArgs = NULL, ...);
