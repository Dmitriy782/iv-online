...
#include "DirectInputHandlerInterface.h"
#ifdef IVMP_WEBKIT
#include "CD3D9Webkit.hpp"
#endif

class CClient : public DirectInputHandlerInterface
{
private:
...
public:
	...
	bool		 		   ProcessInputDeviceState(eDIDeviceType dt, char * keyBuffer, int size, HRESULT oldHResult);
