...
*/
EXPORT void ScriptLoad(lua_State * pVM)
{
	...
	RegisterFunction(pVM, "helloWorld", lua_helloworld);			// only 1 float parameter for function 'helloWorld'
	RegisterFunction(pVM, "createVehicleEx", lua_createVehicleEx);		// any template/count of paramaters for function 'createVehicleEx'
...
*/
EXPORT void ScriptUnload(lua_State * pVM)
{
